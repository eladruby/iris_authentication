...
def build_unet(input_shape=(128, 128, 3)):
    ...
    #יצירת שלושת השכבות שכתבנו מקודם כך שלשכבות הקונבולוציה יש 16 פילטרים 
    c1 = conv_block(x, 16)
    #שכבת מקס פולינג בגודל 2 על 2
    p1 = tf.keras.layers.MaxPooling2D((2, 2))(c1)

    #יצירת שלושת השכבות שכתבנו מקודם כך שלשכבות הקונבולוציה יש 32 פילטרים 
    c2 = conv_block(p1, 32)
    #שכבת מקס פולינג בגודל 2 על 2
    p2 = tf.keras.layers.MaxPooling2D((2, 2))(c2)

    #יצירת שלושת השכבות שכתבנו מקודם כך שלשכבות הקונבולוציה יש 64 פילטרים 
    c3 = conv_block(p2, 64)
    #שכבת מקס פולינג בגודל 2 על 2
    p3 = tf.keras.layers.MaxPooling2D((2, 2))(c3)

    #יצירת שלושת השכבות שכתבנו מקודם כך שלשכבות הקונבולוציה יש 128 פילטרים 
    c4 = conv_block(p3, 128)
    #שכבת מקס פולינג בגודל 2 על 2
    p4 = tf.keras.layers.MaxPooling2D((2, 2))(c4)

    #יצירת שלושת השכבות שכתבנו מקודם כך שלשכבות הקונבולוציה יש 256 פילטרים
    ...
    #שכבת קונבולוציה שגם היא בעלת 128 פילטרים של 3 על 3 ואזעוד שכבת קונבולוציה זהה
    ...
    #שכבת קונבולוציה שגם היא בעלת 64 פילטרים של 3 על 3 ואזעוד שכבת קונבולוציה זהה
    ...
    #שכבת קונבולוציה שגם היא בעלת 32 פילטרים של 3 על 3 ואזעוד שכבת קונבולוציה זהה
    ...
    #שכבת קונבולוציה שגם היא בעלת 16 פילטרים של 3 על 3 ואזעוד שכבת קונבולוציה זהה
